...
def create_collection_if_not_created(self):
...
def get_panns_embs(batch):
  ...
  return batch
    ...
    # Upload new songs to vector database
def upsert_in_batches(music_data, payload, batch_size=100):
  ...
  for i in range(0, total, batch_size):
      ...
      batch_vectors = batch["panns_embeddings"]
...
if __name__ == "__main__":
  ...
  upsert_in_batches(music_data, payload)